...
class IIOPRootDefinition extends PersistentResourceDefinition {
    ...
    static final ParameterValidator VALIDATOR = new EnumValidator<IORTransportConfigValues>(IORTransportConfigValues.class,
            true, true);
            ...
            if (TRANSACTIONS.equals(attributeDefinition)) {
                ...
                if (needJTS != null) {
                    if (needJTS) {
                        ...
                        context.deregisterCapabilityRequirement(IIOPExtension.JTS_CAPABILITY, IIOPExtension.IIOP_ORB_CAPABILITY.getName());
                    }
                }
            } else {
