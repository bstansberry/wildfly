...
public class ApplicationClientDeploymentProcessor implements DeploymentUnitProcessor {
     ...
     * who rely on that behavior to have a workaround to restore it.
     */
    private static final boolean APP_CLIENT_ISOLATED = Boolean.getBoolean("wildfly.appclient.subdeployment.isolated");
